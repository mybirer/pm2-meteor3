...
(function() {
  ...
  program.command('init').description("init a pm2-meteor3 settings file").action(function() {
    return cmds["init"]();
  });
  ...
  program.command('scale <instances>').description('scale App to number-of-instances').action(function(instances) {
    ...
    console.log("  $ pm2-meteor3 scale +2");
    return console.log("  $ pm2-meteor3 scale 4");
  });
