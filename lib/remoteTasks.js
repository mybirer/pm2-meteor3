	...
	module.exports = {
		...
		installBundleDeps: function ({ ssh, connectOptions }, pm2mConf, done) {
			...
			if (appType === 'nextjs' || appType === 'express') {
				...
				cmd = cmdString(pm2mConf, `cd ${installLocation} && node --version && npm install --production --legacy-peer-deps`);
			} else {
				...
				cmd = cmdString(pm2mConf, `cd ${installLocation} && node --version && npm install --production`);
			}
